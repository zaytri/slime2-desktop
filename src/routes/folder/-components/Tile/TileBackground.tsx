...
export default memo(function TileBackground({
	...
	return (
		<div
			className={clsx(
				'absolute inset-0 overflow-hidden border-4 border-black/25 bg-lime-400/75 shadow-[inset_0_-3px_10px_5px] shadow-white/25 backdrop-blur-xs after:absolute after:left-[28%] after:top-[10%] after:h-4 after:w-2 after:rotate-[60deg] after:rounded-100% after:bg-white after:mix-blend-overlay after:content-[""]',
