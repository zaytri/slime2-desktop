...
export default function WidgetButton({ id, label }: WidgetButtonProps) {
	...
	return (
		<button
			type='button'
			className='relative mx-4 flex items-center justify-center overflow-hidden rounded-2 border border-white bg-zinc-200 bg-linear-to-b from-zinc-200 to-zinc-300 px-4 py-1 font-fredoka text-5.5 font-medium text-zinc-700 outline-2 outline-offset-0! outline-zinc-400 over:bg-lime-200 over:bg-none over:text-lime-800 over:outline-4 over:outline-lime-600'
			onClick={() => {
